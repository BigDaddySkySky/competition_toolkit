...
rule CobaltStrike_Resources_Artifact32svc_Exe_v1_49_to_v3_14
{
	...
	*/
	...
	$decoderFunc = { 8B ?? ?? 89 ?? 03 [2] 8B [2] 03 ?? ?? 0f B6 18 8B [2] 89 ?? C1 [2] C1 [2] 01 ?? 83 [2] 29 ?? 03 ?? 31 ?? 88 }
...
rule CobaltStrike_Resources_Artifact32svc_Exe_v3_1_v3_2_v3_14_and_v4_x
{
	...
	/*
		...
		30 [2]          xor     [ebx+ecx], al
	*/
		$decoderFunc  = { 89 ?? B? 04 00 00 00 99 F7 FF 8B ?? ?? 8A ?? ?? 30 }
...
rule CobaltStrike_Resources_Artifact32_and_Resources_Dropper_v1_49_to_v3_14
{
	...
	strings:
		...
		$payloadDecoder = { 8B ?? ?? 89 ?? 03 [2] 8B [2] 03 [2] 0F B6 18 8B [2] 89 ?? C1 ?? 1F C1 ?? 1E 01 ?? 83 ?? 03 29 ?? 03 [2] 0F B6 00 31 ?? 88 ?? 8B [2] 89 ?? 03 [2] 8B [2] 03 [2] 0F B6 12 }
...
rule CobaltStrike_Resources_Artifact32_v3_1_and_v3_2
{
	...
	*/
	...
	$decoderFunc = { 89 ?? B? 04 00 00 00 99 F7 FF 8B ?? ?? 8A [2] 30 ?? 8A ?? 4? 88 }
	condition:
		all of them
}
...
rule CobaltStrike_Resources_Artifact32_v3_14_to_v4_x
{
	...
	*/
	...
	$pushFmtStr = {	C7 ?? ?? ?? 5C 00 00 00 C7 [3] 65 00 00 00 C7 [3] 70 00 00 00 C7 [3] 69 00 00 00 C7 [3] 70 00 00 00 F7 F1 C7 [3] 5C 00 00 00  C7 [3] 2E 00 00 00 C7 [3] 5C 00 00 00 }
...
rule CobaltStrike_Resources_Artifact64_v1_49_v2_x_v3_0_v3_3_thru_v3_14
{
	...
	*/
	...
	$a = { 8B ?? ?? 48 98 48 ?? ?? 48 ?? ?? ?? 8B ?? ?? 48 98 48 ?? ?? ?? 44 ?? ?? ?? 8B ?? ?? 89 ?? C1 ?? 1F C1 ?? 1E 01 ?? 83 ?? 03 29 ?? 48 98 48 ?? ?? ?? 0F B6 00 44 ?? ?? 88 }
...
rule CobaltStrike_Resources_Artifact64_v3_1_v3_2_v3_14_and_v4_0
{
	...
	*/
	...
	$decoderFunction = { 31 ?? EB 0F 41 ?? ?? 03 47 ?? ?? ?? 44 ?? ?? ?? 48 ?? ?? 39 ?? 41 ?? ?? 7C EA 4C ?? ?? ?? ?? ?? ?? E9 }
...
rule CobaltStrike_Resources_Artifact64_v3_14_to_v4_x
{
	...
	*/
	...
	$fmtBuilder = { 41 ?? 5C 00 00 00 C7 ?? ?? ?? 5C 00 00 00 C7 ?? ?? ?? 65 00 00 00 C7 ?? ?? ?? 70 00 00 00 C7 ?? ?? ?? 69 00 00 00 C7 ?? ?? ?? 70 00 00 00 C7 ?? ?? ?? 5C 00 00 00 C7 ?? ?? ?? 2E 00 00 00 89 ?? ?? ?? 48 ?? ?? ?? ?? ?? ?? E8 }
...
rule CobaltStrike_Resources_Beacon_Dll_v1_44
{
  ...
  strings:
    ...
    */
    ...
    /*
      B1 69          mov     cl, 69h ; 'i'
      30 88 ?? ?? ?? ??      xor     byte ptr word_10018F20[eax], cl
      40             inc     eax
      3D 28 01 00 00 cmp     eax, 128h
      7C F2          jl      short loc_10001AD4
    */
    $decode = { B1 ?? 30 88 ?? ?? ?? ?? 40 3D 28 01 00 00 7C F2 }    
...
rule CobaltStrike_Resources_Beacon_Dll_v1_45
{
  ...
  strings:
    ...
    */
    ...
    /*
      B1 69          mov     cl, 69h ; 'i'
      30 88 ?? ?? ?? ??      xor     byte ptr word_10019F20[eax], cl
      40             inc     eax
      3D 28 01 00 00 cmp     eax, 128h
...
rule CobaltStrike_Resources_Beacon_Dll_v1_46
{
  ...
  strings:
    ...
    */   
    ...
    /*
      B1 69          mov     cl, 69h ; 'i'
      30 88 ?? ?? ?? ??      xor     byte ptr word_1001D040[eax], cl
      40             inc     eax
      3D A8 01 00 00 cmp     eax, 1A8h
      7C F2          jl      short loc_10002A04
    */
    $decode = { B1 ?? 30 88 ?? ?? ?? ?? 40 3D A8 01 00 00 7C F2 }
...
rule CobaltStrike_Resources_Beacon_Dll_v1_47
{
  ...
  strings:
    ...
    */
    ...
    /*
      B1 69          mov     cl, 69h ; 'i'
      30 88 ?? ?? ?? ??      xor     byte ptr word_1001E040[eax], cl
      40             inc     eax
      3D A8 01 00 00 cmp     eax, 1A8h
    */
    $decode = { B1 ?? 30 88 ?? ?? ?? ?? 40 3D A8 01 00 00 }
...
rule CobaltStrike_Resources_Beacon_Dll_v1_48
{
  ...
  strings:
    ...
    */
    ...
    /*
      B1 69          mov     cl, 69h ; 'i'
      30 88 ?? ?? ?? ??      xor     byte ptr word_1001F048[eax], cl
      40             inc     eax
      3D A8 01 00 00 cmp     eax, 1A8h
  ...
  strings:
    ...
    */
    ...
    /*
      B1 69            mov     cl, 69h ; 'i'
      90               nop
      30 88 ?? ?? ?? ??        xor     byte ptr word_10022038[eax], cl
      40               inc     eax
      3D A8 01 00 00   cmp     eax, 1A8h
      7C F2            jl      short loc_10005940
    */    
    $decoder = { B1 ?? 90 30 88 ?? ?? ?? ?? 40 3D A8 01 00 00 7C F2 }
  ...
  strings:
    ...
    */
    ...
    /*
      ...
      30 88 ?? ?? ?? ??        xor     byte ptr word_10023038[eax], cl
      40               inc     eax
      3D 30 05 00 00   cmp     eax, 530h
      72 F2            jb      short loc_10006930
    */
    $decoder = { B1 ?? EB 03 8D 49 00 30 88 ?? ?? ?? ?? 40 3D 30 05 00 00 72 F2  }
...
rule CobaltStrike_Resources_Beacon_Dll_v2_1_and_v2_2
{
  ...
  strings:
    ...
    */
    ...
    /*
      80 B0 ?? ?? ?? ?? 69   xor     byte ptr word_1002C040[eax], 69h
      40             inc     eax
      3D 10 06 00 00 cmp     eax, 610h
      72 F1          jb      short loc_1000674A
    */
    $decoder = { 80 B0 ?? ?? ?? ?? ?? 40 3D 10 06 00 00 72 F1 }
...
rule CobaltStrike_Resources_Beacon_Dll_v3_1
{
  ...
  strings:
    /*
      ...
      50             push    eax; name
      FF 15 ?? ?? ?? ??      call    ds:gethostname
      8D 45 ??       lea     eax, [ebp+name]
      50             push    eax; name
      FF 15 ?? ?? ?? ??      call    ds:__imp_gethostbyname
      85 C0          test    eax, eax
      ...
      FF 15 ?? ?? ?? ??      call    ds:inet_ntoa
      EB 05          jmp     short loc_10002B5D
      B8 ?? ?? ?? ??         mov     eax, offset aUnknown; "unknown"
      ...
      C9             leave
    */
    $version_sig = { 55 8B EC 83 EC 58 A1 ?? ?? ?? ?? 33 C5 89 45 FC E8 DF F5 FF FF 6A 50 8D 45 A8 50 FF 15 ?? ?? ?? ?? 8D 45 ?? 50 FF 15 ?? ?? ?? ?? 85 C0 74 14 8B 40 0C 83 38 00 74 0C 8B 00 FF 30 FF 15 ?? ?? ?? ?? EB 05 B8 ?? ?? ?? ?? 8B 4D FC 33 CD E8 82 B7 00 00 C9 }
  ...
  strings:
    ...
    */
    ...
    /*
      ...
      C9             leave
    */
    $version3_1_sig = { 55 8B EC 83 EC 58 A1 ?? ?? ?? ?? 33 C5 89 45 FC E8 DF F5 FF FF 6A 50 8D 45 A8 50 FF 15 ?? ?? ?? ?? 8D 45 ?? 50 FF 15 ?? ?? ?? ?? 85 C0 74 14 8B 40 0C 83 38 00 74 0C 8B 00 FF 30 FF 15 ?? ?? ?? ?? EB 05 B8 ?? ?? ?? ?? 8B 4D FC 33 CD E8 82 B7 00 00 C9 }
...
rule CobaltStrike_Resources_Beacon_Dll_v3_4
{
  ...
  strings:
    ...
    */
    ...
    /*
      80 B0 ?? ?? ?? ?? 69   xor     byte_1002E020[eax], 69h
      40             inc     eax
      3D 00 10 00 00 cmp     eax, 1000h
      7C F1          jl      short loc_10008741
    */
    $decoder = { 80 B0 ?? ?? ?? ?? ?? 40 3D 00 10 00 00 7C F1 }
...
rule CobaltStrike_Resources_Beacon_Dll_v3_8
{
  ...
  strings:
    ...
    */
    ...
    $c2_1 = "ns7.softline.top" 
    $c2_2 = "ns8.softline.top" 
    $c2_3 = "ns9.softline.top" 
    //$a = /[A-Za-z]{1020}.{4}$/
...
rule CobaltStrike_Sleeve_Beacon_Dll_v4_1_and_v4_2
{
  ...
  strings:
    ...
    */
    ...
    /*
      80 B0 ?? ?? ?? ?? 3E   xor     byte_10031010[eax], 3Eh
      40             inc     eax
      3D 00 10 00 00 cmp     eax, 1000h
...
rule CobaltStrike_Sleeve_Beacon_Dll_v4_7_suspected
{
  ...
  strings:
    ...
    */
    ...
    /*
      80 B0 ?? ?? ?? ?? ??      xor     byte_10033020[eax], 2Eh
      40             inc     eax
      3D 00 10 00 00 cmp     eax, 1000h
...
rule CobaltStrike_Resources_Beacon_x64_v3_2
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 4C 8D 05 9F F8 FF FF 8B D3 48 8B CF E8 05 1A 00 00 EB 0A 8B D3 48 8B CF E8 41 21 00 00 48 8B 5C 24 30 48 83 C4 20 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_3
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 8B D3 48 8B CF E8 89 66 00 00 E9 23 FB FF FF 41 B8 01 00 00 00 E9 F3 FD FF FF 48 8D 0D 2A F8 FF FF E8 8D 2B 00 00 48 8B 5C 24 30 48 83 C4 20 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_4
{
  ...
  strings:
    /*
      ...
      48 83 C4 20       add     rsp, 20h
    */
    $version_sig = { 8B D3 48 8B CF E8 56 6F 00 00 E9 17 FB FF FF 41 B8 01 00 00 00 8B D3 48 8B CF E8 41 4D 00 00 48 8B 5C 24 30 48 83 C4 20 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_5_hf1_and_v3_5_1
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 8B D3 48 8B CF E8 38 70 00 00 E9 FD FA FF FF 41 B8 01 00 00 00 8B D3 48 8B CF E8 3F 4D 00 00 48 8B 5C 24 30 48 83 C4 20 5F }
...
rule CobaltStrike_Resources_Beacon_x64_v3_6
{
  ...
  strings:
    ...
    */
    $version_sig = { 48 89 5C 24 08 57 48 83 EC 20 41 8B D8 48 8B FA 83 F9 27 0F 87 47 03 00 00 0F 84 30 03 00 00 83 F9 14 0F 87 A4 01 00 00 0F 84 7A 01 00 00 83 F9 0C 0F 87 C8 00 00 00 0F 84 B3 00 00 00 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_7
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 48 89 5C 24 08 57 48 83 EC 20 41 8B D8 48 8B FA 83 F9 28 0F 87 7F 03 00 00 0F 84 67 03 00 00 83 F9 15 0F 87 DB 01 00 00 0F 84 BF 01 00 00 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_8
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 8B D3 48 8B CF E8 7A 52 00 00 EB 0D 45 33 C0 8B D3 48 8B CF E8 8F 55 00 00 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_11
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 48 83 EC 20 41 8B D8 48 8B FA 83 F9 2D 0F 87 B2 03 00 00 0F 84 90 03 00 00 83 F9 17 0F 87 F8 01 00 00 0F 84 DC 01 00 00 83 F9 0E 0F 87 F9 00 00 00 0F 84 DD 00 00 00 FF C9 0F 84 C0 00 00 00 83 E9 02 0F 84 A6 00 00 00 FF C9 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_12
{
  ...
  strings:
    ...
    */
    $version_sig = { 8B D3 48 8B CF E8 F8 2E 00 00 EB 16 8B D3 48 8B CF E8 00 5C 00 00 EB 0A 8B D3 48 8B CF E8 64 4F 00 00 }
...
rule CobaltStrike_Resources_Beacon_x64_v3_13
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 48 8D 0D 01 5B FF FF 48 83 C4 28 E9 A8 54 FF FF 8B D0 49 8B CA E8 22 55 FF FF }
...
rule CobaltStrike_Resources_Beacon_x64_v3_14
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 8B D0 49 8B CA 48 83 C4 28 E9 B1 1F 00 00 8B D0 49 8B CA 48 83 C4 28 }
...
rule CobaltStrike_Sleeve_Beacon_Dll_x86_v4_0_suspected
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 41 B8 01 00 00 00 8B D0 49 8B CA 48 83 C4 28 E9 D1 B3 FF FF 8B D0 49 8B CA 48 83 C4 28 E9 AF F5 FF FF 45 33 C0 4C 8D 0D 8D 70 FF FF 8B D0 49 8B CA E8 9B B0 FF FF }
...
rule CobaltStrike_Sleeve_Beacon_x64_v4_1_and_v_4_2
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 83 F9 34 0F 87 8E 03 00 00 0F 84 7A 03 00 00 83 F9 1C 0F 87 E6 01 00 00 0F 84 D7 01 00 00 83 F9 0E 0F 87 E9 00 00 00 0F 84 CE 00 00 00 FF C9 0F 84 B8 00 00 00 83 E9 02 0F 84 9F 00 00 00 FF C9 }
...
rule CobaltStrike_Sleeve_Beacon_x64_v4_3
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 8B D0 49 8B CA 48 83 C4 28 E9 D3 88 FF FF 4C 8D 05 84 6E FF FF 8B D0 49 8B CA 48 83 C4 28 }
...
rule CobaltStrike_Sleeve_Beacon_x64_v4_4_v_4_5_and_v4_6
{
  ...
  strings:
    ...
    */
    ...
    $version_sig = { 8B D0 49 8B CA 48 83 C4 28 E9 83 88 FF FF 4C 8D 05 A4 6D FF FF 8B D0 49 8B CA 48 83 C4 28 }
...
rule CobaltStrike_Sleeve_Beacon_x64_v4_5_variant
{
  ...
  strings:
    /*
      ...
      48 83 C4 28       add     rsp, 28h
    */
    $version_sig = { 41 B8 01 00 00 00 8B D0 49 8B CA 48 83 C4 28 E9 E8 AB FF FF8B D0 49 8B CA E8 1A EB FF FF 48 83 C4 28 }
...
rule CobaltStrike_Resources_Bind64_Bin_v2_5_through_v4_x
{
	...
	*/
	...
	$apiLocator = { 48 ?? ?? AC 41 ?? ?? 0D 41 ?? ?? 38 ?? 75 ?? 4C ?? ?? ?? ?? 45 ?? ?? 75 ?? 5? 44 ?? ?? 24 49 ?? ?? 66 ?? ?? ?? ?? 44 ?? ?? 1C 49 ?? ?? 41 ?? ?? ?? 48 }
  ...
  // unchanged. This means we can use these values as anchors in our signature.
	...
	*/
	...
	$calls = { 41 BA C2 DB 37 67 FF D5 48 ?? ?? 48 ?? ?? 41 BA B7 E9 38 FF FF D5 4D ?? ?? 48 ?? ?? 48 ?? ?? 41 BA 74 EC 3B E1 FF D5 48 ?? ?? 48 ?? ?? 41 BA 75 6E 4D 61 }
...
rule CobaltStrike_Resources_Bind_Bin_v2_5_through_v4_x
{
	...
	*/
	...
	$apiLocator = { 31 ?? AC C1 ?? 0D 01 ?? 38 ?? 75 ?? 03 [2] 3B [2] 75 ?? 5? 8B ?? 24 01 ?? 66 8B [2] 8B ?? 1C 01 ?? 8B ?? 8B 01 ?? 89 [3] 5? 5? }
	...
	*/
	...
	$ws2_32 = { 5D 68 33 32 00 00 68 77 73 32 5F }
  ...
  // approach to finding bind.bin specific samples
	...
	*/
	$listenaccept = { 5? 5? 68 B7 E9 38 FF FF ?? 5? 5? 5? 68 74 EC 3B E1 }
...
$socket_recv_1 = { FF ?? 83 ?? FF 74 ?? 85 C0 (74 | 76) ?? 03 ?? 83 ?? 02 72 ?? 80 ?? 3E FF 0A 75 ?? 80 ?? 3E FE 0D }
$socket_recv_2 = { FF ?? ?? 83 ?? FF 74 ?? 85 C0 (74 | 76) ?? 03 ?? 83 ?? 02 72 ?? 80 ?? 3E FF 0A 75 ?? 80 ?? 3E FE 0D }		
$socket_recv_3 = { FF ?? ?? ?? 83 ?? FF 74 ?? 85 C0 (74 | 76) ?? 03 ?? 83 ?? 02 72 ?? 80 ?? 3E FF 0A 75 ?? 80 ?? 3E FE 0D }
$socket_recv_4 = { FF ?? ?? ?? ?? 83 ?? FF 74 ?? 85 C0 (74 | 76) ?? 03 ?? 83 ?? 02 72 ?? 80 ?? 3E FF 0A 75 ?? 80 ?? 3E FE 0D }
$socket_recv_5 = { FF ?? ?? ?? ?? ?? 83 ?? FF 74 ?? 85 C0 (74 | 76) ?? 03 ?? 83 ?? 02 72 ?? 80 ?? 3E FF 0A 75 ?? 80 ?? 3E FE 0D }
  // distinctive regex (sscanf) format string
  $fmt = "%1024[^ ] %8[^:]://%1016[^/]%7168[^ ] %1024[^ ]"

	condition:
		($socket_recv_1 or $socket_recv_2 or$socket_recv_3 or $socket_recv_4 or $socket_recv_5) and $fmt
}/*
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
rule CobaltStrike_Resources_Browserpivot_x64_Bin_v1_48_to_v3_14_and_Sleeve_Browserpivot_x64_Dll_v4_0_to_v4_x
{
	...
	/*
		...
		8D ?? FF          lea     eax, [rbx-1]
		80 ?? ?? 0A         cmp     byte ptr [rax+rdi], 0Ah
		75 ??             jnz     short loc_1800018F7
		8D ?? FE          lea     eax, [rbx-2]
		80 ?? ?? 0D         cmp     byte ptr [rax+rdi], 0Dh
	*/

$socket_recv = { FF 15 ?? ?? ?? ?? 83 ?? FF 74 ?? 85 ?? 74 ?? 03 ?? 83 ?? 02 72 ?? 8D ?? FF 80 ?? ?? 0A 75 ?? 8D ?? FE 80 ?? ?? 0D }
  // distinctive regex (sscanf) format string
  $fmt = "%1024[^ ] %8[^:]://%1016[^/]%7168[^ ] %1024[^ ]"
...
rule CobaltStrike_Resources_Bypassuactoken_Dll_v3_11_to_v3_14
{
	...
	/*
		...
		FF 15 ?? ?? ?? ??          call    ds:GetTokenInformation
		85 C0              test    eax, eax
		75 ??              jnz     short loc_10001100
		FF 15 ?? ?? ?? ??          call    ds:GetLastError
		83 ?? 7A           cmp     eax, 7Ah ; 'z'
		75 ??              jnz     short loc_10001100
		FF ?? ??             push    [ebp+ReturnLength]; uBytes
		5?                 push    edi; uFlags
		FF 15 ?? ?? ?? ??          call    ds:LocalAlloc
		8B ??              mov     esi, eax
		8D ?? ??             lea     eax, [ebp+ReturnLength]
		5?                 push    eax; ReturnLength
		FF ?? ??             push    [ebp+ReturnLength]; TokenInformationLength
		...
		FF 15 ?? ?? ?? ??          call    ds:GetSidSubAuthorityCount
		8A ??              mov     al, [eax]
		FE C8              dec     al
		0F B6 C0           movzx   eax, al
		5?                 push    eax; nSubAuthority
		FF ??              push    dword ptr [esi]; pSid
		FF 15 ?? ?? ?? ??          call    ds:GetSidSubAuthority
		B? 01 00 00 00     mov     ecx, 1
		5?                 push    esi; hMem
		81 ?? 00 30 00 00  cmp     dword ptr [eax], 3000h
	*/

$isHighIntegrityProcess = { 5? 5? 5? 8B ?? 6A 19 5? FF 15 ?? ?? ?? ?? 85 C0 75 ?? FF 15 ?? ?? ?? ?? 83 ?? 7A 75 ?? FF ?? ?? 5? FF 15 ?? ?? ?? ?? 8B ?? 8D ?? ?? 5? FF ?? ?? 5? 6A 19 5? FF 15 ?? ?? ?? ?? 85 C0 74 ?? FF ?? FF 15 ?? ?? ?? ?? 8A ?? FE C8 0F B6 C0 5? FF ?? FF 15 ?? ?? ?? ?? B? 01 00 00 00 5? 81 ?? 00 30 00 00 }
	/*
		6A 3C               push    3Ch ; '<'; Size
		...
		C7 ?? ?? 3C 00 00 00  mov     [ebp+pExecInfo.cbSize], 3Ch ; '<'
		8D ?? ??              lea     eax, [ebp+pExecInfo]
		C7 ?? ?? 40 00 00 00  mov     [ebp+pExecInfo.fMask], 40h ; '@'
		C7 ?? ?? ?? ?? ?? ??              mov     [ebp+pExecInfo.lpFile], offset aTaskmgrExe; "taskmgr.exe"
		C7 ?? ?? 00 00 00 00  mov     [ebp+pExecInfo.lpParameters], 0
		5?                  push    eax; pExecInfo
		C7 ?? ?? 00 00 00 00  mov     [ebp+pExecInfo.lpDirectory], 0
		C7 ?? ?? ?? ?? ?? ??              mov     [ebp+pExecInfo.lpVerb], offset aRunas; "runas"
		C7 ?? ?? 00 00 00 00  mov     [ebp+pExecInfo.nShow], 0
		FF 15 ?? ?? ?? ??           call    ds:ShellExecuteExW
		FF 75 FC            push    [ebp+pExecInfo.hProcess]; Process
	*/

$executeTaskmgr = { 6A 3C 8D ?? C4 8B ?? 6A 00 5? 8B ?? E8 ?? ?? ?? ?? 83 C4 0C C7 ?? ?? 3C 00 00 00 8D ?? ?? C7 ?? ?? 40 00 00 00 C7 ?? ?? ?? ?? ?? ?? C7 ?? ?? 00 00 00 00 5? C7 ?? ?? 00 00 00 00 C7 ?? ?? ?? ?? ?? ?? C7 ?? ?? 00 00 00 00 FF 15 ?? ?? ?? ?? FF 75 FC }		
	condition:
		all of them
}/*
 * Copyright 2022 Google LLC
...
$isHighIntegrityProcess = { 83 ?? 7A 75 ?? 8B ?? ?? ?? 33 ?? FF 15 ?? ?? ?? ?? 44 ?? ?? ?? ?? 8D ?? ?? 48 8B ?? 48 8D ?? ?? ?? 48 8B ?? 4C 8B ?? 48 89 ?? ?? ?? FF 15 ?? ?? ?? ?? 85 C0 74 ?? 48 8B ?? FF 15 ?? ?? ?? ?? 8D ?? ?? 8A ?? 40 ?? ?? 0F B6 D1 48 8B 0F FF 15 ?? ?? ?? ?? 81 ?? 00 30 00 00 }
	/*
...
$executeTaskmgr = { 44 8D ?? 70 48 8D ?? ?? ?? E8 ?? ?? ?? ?? 83 ?? ?? ?? 00 48 8D ?? ?? ?? ?? ?? 0F 57 ?? 66 0F 7F ?? ?? ?? 48 89 ?? ?? ?? 48 8D ?? ?? ?? ?? ?? 48 8D ?? ?? ?? C7 ?? ?? ?? 70 00 00 00 C7 ?? ?? ?? 40 00 00 00 48 89 ?? ?? ?? FF 15 }
...
$deleteFileCOM = { A1 ?? ?? ?? ?? 6A 00 8B ?? 5? 5? FF ?? 48 85 ?? 75 ?? A1 ?? ?? ?? ?? 5? 8B ?? FF ?? 54 }
	/*
		A1 ?? ?? ?? ??    mov     eax, fileop
		6A 00     push    0
...
//$copyFileCOM = { A1 ?? ?? ?? ?? 6A 00 FF ?? ?? 8B ?? FF ?? ?? ?? ?? ?? FF ?? ?? ?? ?? ?? 5? FF ?? 40 85 ?? [2 - 6] A1 ?? ?? ?? ?? 5? 8B ?? FF ?? 54 }		
$copyFileCOM2 = { A1 ?? ?? ?? ?? 6A 00 FF ?? ?? 8B ?? FF ?? ?? ?? ?? ?? FF ?? ?? ?? ?? ?? 5? FF ?? 40 85 ?? ?? ?? A1 ?? ?? ?? ?? 5? 8B ?? FF ?? 54 }	
$copyFileCOM3 = { A1 ?? ?? ?? ?? 6A 00 FF ?? ?? 8B ?? FF ?? ?? ?? ?? ?? FF ?? ?? ?? ?? ?? 5? FF ?? 40 85 ?? ?? ?? ?? A1 ?? ?? ?? ?? 5? 8B ?? FF ?? 54 }	
$copyFileCOM4 = { A1 ?? ?? ?? ?? 6A 00 FF ?? ?? 8B ?? FF ?? ?? ?? ?? ?? FF ?? ?? ?? ?? ?? 5? FF ?? 40 85 ?? ?? ?? ?? ?? A1 ?? ?? ?? ?? 5? 8B ?? FF ?? 54 }	
$copyFileCOM5 = { A1 ?? ?? ?? ?? 6A 00 FF ?? ?? 8B ?? FF ?? ?? ?? ?? ?? FF ?? ?? ?? ?? ?? 5? FF ?? 40 85 ?? ?? ?? ?? ?? ?? A1 ?? ?? ?? ?? 5? 8B ?? FF ?? 54 }		
$copyFileCOM6 = { A1 ?? ?? ?? ?? 6A 00 FF ?? ?? 8B ?? FF ?? ?? ?? ?? ?? FF ?? ?? ?? ?? ?? 5? FF ?? 40 85 ?? ?? ?? ?? ?? ?? ?? A1 ?? ?? ?? ?? 5? 8B ?? FF ?? 54 }	
				
	condition:
		$deleteFileCOM and ($copyFileCOM2 or $copyFileCOM3 or $copyFileCOM4 or $copyFileCOM5 or $copyFileCOM6)
}/*
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
$deleteFileCOM = { 48 8B ?? ?? ?? ?? ?? 45 33 ?? 48 8B ?? FF 90 90 00 00 00 85 C0 75 ?? 48 8B ?? ?? ?? ?? ?? 48 8B ?? FF 92 A8 00 00 00 85 C0 }	
...
$copyFileCOM = { 48 8B ?? ?? ?? ?? ?? 4C 8B ?? ?? ?? ?? ?? 48 8B ?? ?? ?? ?? ?? 48 8B ?? 4C 8B ?? 48 89 ?? ?? ?? FF 90 80 00 00 00 85 C0 0F 85 ?? ?? ?? ?? 48 8B ?? ?? ?? ?? ?? 48 8B 11 FF 92 A8 00 00 00 }
	condition:
		all of them
}
/*
...
rule CobaltStrike_Resources_Covertvpn_Dll_v2_1_to_v4_x
{
	...
	/*
		5?                  push    esi
		68 ?? ?? ?? ??              push    offset ProcName; "IsWow64Process"
		68 ?? ?? ?? ??              push    offset ModuleName; "kernel32"
		...
		50                  push    eax; hModule
		FF 15 ?? ?? ?? ??           call    ds:GetProcAddress
		8B ??               mov     esi, eax
		85 ??               test    esi, esi
		74 ??               jz      short loc_1000298B
		8D [3-5]            lea     eax, [ebp+var_9C]                 // the displacement bytes are only 3 in v2.x, 5 in v3.x->v4.x
		5?                  push    eax
		FF 15 ?? ?? ?? ??           call    ds:GetCurrentProcess
		50                  push    eax
	*/

// $dropComponentsAndActivateDriver_prologue = { 5? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? C7 [3-5] 00 00 00 00 FF 15 ?? ?? ?? ?? 50 FF 15 ?? ?? ?? ?? 8B ?? 85 ?? 74 ?? 8D [3-5] 5? FF 15 ?? ?? ?? ?? 50 }
   $dropComponentsAndActivateDriver_prologue = { 5? 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? C7 ?? ?? ?? 00 00 00 00 FF 15 ?? ?? ?? ?? 50 FF 15 ?? ?? ?? ?? 8B ?? 85 ?? 74 ?? 8D ?? ?? ?? 5? FF 15 ?? ?? ?? ?? 50 }
	/*
		...
		5?             push    esi
		68 ?? ?? ?? ??         push    offset aWarningSExists; "Warning: %s exists\n"   // this may not exist in v2.x samples
		E8 ?? ?? ?? ??         call    nullsub_1
...
$dropFile = { 6A 00 5? E8 ?? ?? ?? ?? 83 C4 08 83 F8 FF 74 ?? 5? [0-5] E8 ?? ?? ?? ?? 83 C4 ?? [0-2] 6A 00 68 80 01 00 00 6A 02 6A 00 6A 05 68 00 00 00 40 5? FF 15 ?? ?? ?? ?? 8B ?? 83 ?? FF 75 ?? FF 15 ?? ?? ?? ?? 5? }	
	$nfp = "npf.sys" nocase
...
rule CobaltStrike_Resources_Covertvpn_injector_Exe_v1_44_to_v2_0_49
{
	...
	strings:
	/*
		C7 04 24 ?? ?? ?? ??    mov     dword ptr [esp], offset aKernel32; "kernel32"
		E8 ?? ?? ?? ??          call    GetModuleHandleA
		83 EC 04        sub     esp, 4
		C7 44 24 04 ?? ?? ?? ?? mov     dword ptr [esp+4], offset aIswow64process; "IsWow64Process"
		...
		E8 ?? ?? ?? ??          call    GetCurrentProcess
		8D ?? ??          lea     edx, [ebp+fIs64bit]
		89 ?? ?? ??          mov     [esp+4], edx
		89 04 24        mov     [esp], eax
	*/

$dropComponentsAndActivateDriver_prologue = { C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 04 C7 44 24 04 ?? ?? ?? ?? 89 04 24 E8 59 14 00 00 83 EC 08 89 45 ?? 83 7D ?? 00 74 ?? E8 ?? ?? ?? ?? 8D ?? ?? 89 ?? ?? ?? 89 04 24 }
	/*
		C7 44 24 04 00 00 00 00 mov     dword ptr [esp+4], 0; AccessMode
		8B ?? ??                  mov     eax, [ebp+FileName]
		...
		C7 04 24 ?? ?? ?? ??            mov     dword ptr [esp], offset aWarningSExists; "Warning: %s exists\n"
		E8 ?? ?? ?? ??                  call    log
		E9 ?? ?? ?? ??                  jmp     locret_401871
...
$dropFile = { C7 44 24 04 00 00 00 00 8B ?? ?? 89 ?? 24 E8 ?? ?? ?? ?? 83 F8 FF 74 ?? 8B ?? ?? 89 ?? 24 04 C7 04 24 ?? ?? ?? ?? E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? C7 44 24 18 00 00 00 00 C7 44 24 14 80 01 00 00 C7 44 24 10 02 00 00 00 C7 44 24 0C 00 00 00 00 C7 44 24 08 05 00 00 00 C7 44 24 04 00 00 00 40 8B ?? ?? 89 04 24 E8 ?? ?? ?? ?? 83 EC 1C 89 45 ?? }
	$nfp = "npf.sys" nocase
	$wpcap = "wpcap.dll" nocase
...
rule CobaltStrike_Resources_Dnsstager_Bin_v1_47_through_v4_x
{
	...
	/*
		...
		8B ?? 24  mov     ebx, [eax+24h]
		01 ??     add     ebx, edx
		66 8B ?? ?? mov     cx, [ebx+ecx*2]
		8B ?? 1C  mov     ebx, [eax+1Ch]
		01 ??     add     ebx, edx
		8B ?? 8B  mov     eax, [ebx+ecx*4]
		01 ??     add     eax, edx
		89 ?? ?? ??    mov     [esp+28h+var_4], eax
		5?        pop     ebx
		5?        pop     ebx
	*/

$apiLocator = { 31 ?? AC C1 ?? 0D 01 ?? 38 ?? 75 ?? 03 ?? ?? 3B ?? ?? 75 ?? 5? 8B ?? 24 01 ?? 66 8B ?? ?? 8B ?? 1C 01 ?? 8B ?? 8B 01 ?? 89 ?? ?? ?? 5? 5? }
...
rule CobaltStrike_Resources_Elevate_Dll_v3_0_to_v3_14_and_Sleeve_Elevate_Dll_v4_x
{
	...
	/*
		...
		5?                  push    edi; hWnd
		C7 ?? ?? ?? ?? ?? 01 00 00 00  mov     dword_10017E70, 1
...
$wnd_proc = { 6A 00 6A 28 68 00 01 00 00 5? C7 ?? ?? ?? ?? ?? 01 00 00 00 FF ?? 6A 00 6A 27 68 00 01 00 00 5? FF ?? 6A 00 6A 00 68 01 02 00 00 5? FF ?? }
...
$wnd_proc = { 81 ?? 21 01 00 00 75 ?? 83 ?? ?? ?? ?? ?? 00 75 ?? 45 33 ?? 8D ?? ?? C7 ?? ?? ?? ?? ?? 01 00 00 00 45 ?? ?? 28 FF 15 ?? ?? ?? ?? 45 33 ?? 8D ?? ?? 45 ?? ?? 27 48 ?? ?? FF 15 ?? ?? ?? ?? 45 33 ?? 45 33 ?? BA 01 02 00 00 48 }
	condition:
		$wnd_proc
}/*
 * Copyright 2022 Google LLC
...
$InternetSetOptionA = { BA 1F 00 00 00 6A 00 68 80 33 00 00 49 ?? ?? 41 ?? 04 00 00 00 41 ?? 75 46 9E 86 }	
	condition:
...
$InternetSetOptionA = { 6A 04 5? 6A 1F 5? 68 75 46 9E 86 FF }	
	condition:
		$apiLocator and $InternetSetOptionA
}/*
 * Copyright 2022 Google LLC
...
$postInternetOpenJmp = { 41 ?? 3A 56 79 A7 FF ?? EB }
...
$apiLocator = { 31 ?? AC C1 ?? 0D 01 ?? 38 ?? 75 ?? 03 ?? ?? 3B ?? ?? 75 ?? 5? 8B ?? 24 01 ?? 66 8B ?? ?? 8B ?? 1C 01 ?? 8B ?? 8B 01 ?? 89 ?? ?? ?? 5? 5? }
  ...
  // and the httpstager controls the download loop slightly different than the httpsstager
	/*
		...
		31 ??           xor     edi, edi
		E9 ?? ?? ?? ??          jmp     loc_100002CA      // opcode could also be EB for a short jump (v2.5-v3.10)
	*/

$downloaderLoop = { B? 00 2F 00 00 39 ?? 74 ?? 31 ?? ( E9 | EB ) }
	condition:
...
$calls = { 48 89 C1 41 BA EA 0F DF E0 FF D5 48 ?? ?? 6A ?? 41 ?? 4C ?? ?? 48 ?? ?? 41 BA 99 A5 74 61 FF D5 }	condition:
		$apiLocator and $calls
}
/*
 * Copyright 2022 Google LLC
...
$ws2_32 = { 5D 68 33 32 00 00 68 77 73 32 5F }
  ...
  // so the presence of the connect API hash is a solid method for distinguishing between the two.
	...
	*/
$connect = { 6A 10 5? 5? 68 99 A5 74 61 }	
	condition:
...
$smbstart = { 6A 40 68 00 10 00 00 68 FF FF 07 00 6A 00 68 58 A4 53 E5 }	
	condition:
...
$core_sig = { C6 45 F0 48 C6 45 F1 65 C6 45 F2 61 C6 45 F3 70 C6 45 F4 41 C6 45 F5 6C C6 45 F6 6C C6 45 F7 6F C6 45 F8 63 C6 45 F9 00 }
...
$core_sig = { C6 45 EC 4D C6 45 ED 61 C6 45 EE 70 C6 45 EF 56 C6 45 F0 69 C6 45 F1 65 C6 45 F2 77 C6 45 F3 4F C6 45 F4 66 C6 45 F5 46 C6 45 F6 69 C6 45 F7 6C C6 45 F8 65 C6 45 F9 00 }
    // These strings can narrow down the specific version
...
$core_sig = { C6 45 B0 56 C6 45 B1 69 C6 45 B2 72 C6 45 B3 74 C6 45 B4 75 C6 45 B5 61 C6 45 B6 6C C6 45 B7 41 C6 45 B8 6C C6 45 B9 6C C6 45 BA 6F C6 45 BB 63 C6 45 BC 00 }
    /*
      8B 4D FC    mov     ecx, [ebp+var_4]
      83 C1 01    add     ecx, 1
...
$deobfuscator = { 8B 4D FC 83 C1 01 89 4D FC 8B 55 FC 3B 55 0C 73 19 0F B6 45 10 8B 4D 08 03 4D FC 0F BE 11 33 D0 8B 45 08 03 45 FC 88 10 EB D6 }    
  condition:
    all of them
}
...
$core_sig = { C6 44 24 38 48 C6 44 24 39 65 C6 44 24 3A 61 C6 44 24 3B 70 C6 44 24 3C 41 C6 44 24 3D 6C C6 44 24 3E 6C C6 44 24 3F 6F C6 44 24 40 63 C6 44 24 41 00 }
    // These strings can narrow down the specific version
...
$core_sig = { C6 44 24 58 4D C6 44 24 59 61 C6 44 24 5A 70 C6 44 24 5B 56 C6 44 24 5C 69 C6 44 24 5D 65 C6 44 24 5E 77 C6 44 24 5F 4F C6 44 24 60 66 C6 44 24 61 46 C6 44 24 62 69 C6 44 24 63 6C C6 44 24 64 65 }
    // These strings can narrow down the specific version
    //$ver_43 = { 96 2C 3E 60 }         // Version 4.3
...
$core_sig = { C6 44 24 48 56 C6 44 24 49 69 C6 44 24 4A 72 C6 44 24 4B 74 C6 44 24 4C 75 C6 44 24 4D 61 C6 44 24 4E 6C C6 44 24 4F 41 C6 44 24 50 6C C6 44 24 51 6C C6 44 24 52 6F C6 44 24 53 63 C6 44 24 54 00 }
...
$deobfuscator = { 8B 04 24 FF C0 89 04 24 8B 44 24 28 39 04 24 73 20 8B 04 24 0F B6 4C 24 30 48 8B 54 24 20 0F BE 04 02 33 C1 8B 0C 24 48 8B 54 24 20 88 04 0A }
...
$core_sig = { 33 C0 83 F8 01 74 63 48 8B 44 24 20 0F B7 00 3D 4D 5A 00 00 75 45 48 8B 44 24 20 48 63 40 3C 48 89 44 24 28 48 83 7C 24 28 40 72 2F 48 81 7C 24 28 00 04 00 00 73 24 48 8B 44 24 20 48 8B 4C 24 28 48 03 C8 48 8B C1 48 89 44 24 28 48 8B 44 24 28 81 38 50 45 00 00 75 02 }
    /*
      8B 04 24       mov     eax, [rsp+18h+var_18]
      FF C0          inc     eax
      89 04 24       mov     [rsp+18h+var_18], eax
